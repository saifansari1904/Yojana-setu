...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-[400px] flex items-center justify-center p-6 bg-[#FAFAF9] dark:bg-[var(--bg-card)]">
          <div className="max-w-md w-full bg-white dark:bg-[var(--bg-card)] rounded-lg border border-[#E4E8E4] dark:border-[var(--border-subtle)] p-6 shadow-sm text-center">
            ...
            <h2 className="text-lg font-bold text-[#14453D] dark:text-[var(--text-main)] mb-2">
              Something went wrong
            </h2>
            <p className="text-xs text-[#516A5F] dark:text-[var(--text-secondary)] mb-6 leading-relaxed">
