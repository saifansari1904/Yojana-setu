  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div className="p-3.5 rounded-lg bg-[#FAFBF9] dark:bg-[var(--bg-raised)] border border-slate-200 dark:border-slate-800">
          <div className="flex items-center gap-1.5 text-xs text-slate-500 dark:text-slate-400 font-medium">
            <CheckCircle2 className="w-3.5 h-3.5 text-[#0F6B4C] dark:text-[var(--accent-green)]" />
      ...
      {hasApplications && applications.length > 0 && (
        <div className="pt-2 border-t border-slate-100 dark:border-[var(--border-subtle)] space-y-2">
              ...
              >
                ...
                {onOpenWorkspace && (
                  <button
                    ...
                    className="text-xs font-semibold text-[#0F6B4C] dark:text-[var(--accent-green)] hover:underline flex items-center gap-1 min-h-[44px]"
                  >
