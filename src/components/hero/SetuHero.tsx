...
> = {
  ...
  mr: {
    compactTitle1: 'उद्योजक आणि ',
    compactHighlight: 'शासकीय योजना',
    compactTitle2: ' यांच्यातील बुद्धिमान सेतू',
    compactDesc:
      'सूक्ष्म, लघु आणि ग्रामीण उद्योजकांना निश्चित पात्रता पडताळणी, वास्तविक-वेळ निधी गणना आणि मार्गदर्शित अर्ज सहाय्यासह सक्षम बनवणे.',
    fullEyebrow: 'योजना सेतू इंटेलिजन्स',
    fullTitle1: 'आपल्या व्यवसायासाठी ',
    fullHighlight: 'योग्य शासकीय सहाय्य',
    fullTitle2: ' शोधा.',
    fullDesc:
      'आपली प्रोफाइल भरा आणि कोणत्या योजना तुमच्याशी जुळतात, त्या का जुळतात आणि पुढे काय करावे हे पाहा — प्रत्येक शिफारस पडताळणी केलेल्या शासकीय स्रोताशी जोडलेली आहे.',
    ctaPrimary: 'माझ्या योजना शोधा',
    ctaSecondary: 'हे कसे कार्य करते',
    journeyAria: 'योजना सेतू प्रवास',
    steps: [
      { label: 'उद्योजक', hint: 'आपला व्यवसाय' },
      { label: 'प्रोफाइल', hint: 'संरचित माहिती' },
      { label: 'इंटेलिजन्स', hint: 'निश्चित नियम गणना' },
      { label: 'शासकीय योजना', hint: 'पडताळलेले स्रोत' },
      { label: 'पुढील पाऊल', hint: 'तयारी आणि अर्ज' },
    ],
    pillars: [
      {
        title: 'राजपत्र-पडताळलेले नियम इंजिन',
        body: 'AI कल्पना नाही. पात्रता केवळ अधिकृत मंत्रालय निकषांवरून गणना केली जाते.',
      },
      {
        title: 'गोपनीयता-प्रथम रचना',
        body: 'तुमचे तपशील तुमच्या ब्राउझर सत्रात राहतात; कोणतीही संवेदनशील ओळख संग्रहित केली जात नाही.',
      },
    ],
  },
};
