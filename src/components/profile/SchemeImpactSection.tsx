  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
        <div className="p-4 rounded-xl bg-[#F4F8F5] dark:bg-[#141b17] border border-[#D9E8DF] dark:border-[#1E3E2E] flex items-center justify-between">
          <div>
            <span className="text-xs font-bold text-[#14453D] dark:text-[#4ADE80] block">
              {strings.eligibleCount}
            </span>
            <span className="text-2xl sm:text-3xl font-black text-[#14453D] dark:text-[#4ADE80] mt-1 block">
              {eligible.length}
            </span>
          </div>
      ...
      {topMatches.length > 0 && (
        <div className="space-y-2.5 mb-5">
          <span className="text-xs font-bold uppercase tracking-wider text-[#516A5F] dark:text-[#9EB0A7] block">
            ...
            {topMatches.map((res) => {
              ...
              return (
                <button
                  ...
                  className="p-3.5 rounded-xl bg-[#F9FAF9] dark:bg-[#141b17] border border-[#E8EFEA] dark:border-[#1E2E27] hover:border-[#1E6A50] transition-all text-left flex flex-col justify-between cursor-pointer group"
                >
                  <div>
                    ...
                    <h4 className="text-xs font-bold text-[#1F2421] dark:text-[#F0F4F2] group-hover:text-[#14453D] dark:group-hover:text-[#4ADE80] line-clamp-2 transition-colors">
                      {locScheme.name}
                    </h4>
                  </div>

                  <div className="mt-3 pt-2 border-t border-[#E8EFEA] dark:border-[#1E2E27] flex items-center justify-between text-[11px] text-[#516A5F] dark:text-[#9EB0A7]">
                    <span className="truncate">{locScheme.fundingRangeText || 'Government Credit'}</span>
                    <ArrowRight className="w-3.5 h-3.5 text-[#14453D] dark:text-[#4ADE80] shrink-0" />
                  </div>
                </button>
              );
            })}
      ...
      <div className="p-3.5 rounded-xl bg-[#F4F7F5] dark:bg-[#141b17] border border-[#DEE7E2] dark:border-[#1E2E27] flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs text-[#516A5F] dark:text-[#9EB0A7]">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            className="inline-flex items-center gap-1 text-xs font-semibold text-[#14453D] dark:text-[#4ADE80] hover:underline cursor-pointer"
          >
