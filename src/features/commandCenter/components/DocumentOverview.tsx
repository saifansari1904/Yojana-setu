    ...
    >
      <div>
        ...
        <div className="grid grid-cols-3 gap-2.5 mb-4">
          ...
          <div className="p-3 rounded-lg bg-[#FAFAF9] dark:bg-[#1A2420] border border-[#E4E8E4] dark:border-[#24342D] text-center">
      ...
      <div>
        ...
        <div className="flex items-center gap-1.5 text-[11px] text-[#516A5F] dark:text-[#8E9F97] bg-[#FAFAF9] dark:bg-[#1A2420] p-2 rounded-md mb-3 border border-[#EAECEB] dark:border-[#24342D]">
