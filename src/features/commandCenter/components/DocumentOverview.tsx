    ...
    >
      <div>
        ...
        <div className="grid grid-cols-3 gap-2.5 mb-4">
          ...
          <div className="p-3 rounded-lg bg-[#FAFAF9] dark:bg-[#1A2420] border border-[#E2E2E0] dark:border-[#24342D] text-center">
          ...
          <button
            ...
            className={`pb-2 px-3 font-semibold transition-colors border-b-2 -mb-px ${
              activeTab === 'reusable'
                ...
                : 'border-transparent text-[#6F7A73] dark:text-[#8E9F97] hover:text-[#3F4943] dark:hover:text-[#F0F4F2]'
            }`}
          >
      ...
      <div>
        ...
        <div className="flex items-center gap-1.5 text-[11px] text-[#6F7A73] dark:text-[#8E9F97] bg-[#FAFAF9] dark:bg-[#1A2420] p-2 rounded-md mb-3 border border-[#EAECEB] dark:border-[#24342D]">
