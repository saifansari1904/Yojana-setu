  ...
  return (
    <div id={id} className="max-w-4xl mx-auto py-10 sm:py-16 px-4">
      <div className="yj-card yj-card-lg p-8 sm:p-12 text-center">
        ...
        <h1 className="text-xl sm:text-4xl font-bold text-[#1A1C1B] dark:text-[#F0F4F2] tracking-tight mb-4">
          {t('welcomeTitle')}
        </h1>

        <p className="text-base sm:text-lg text-[#516A5F] dark:text-[#9EB0A7] max-w-xl mx-auto mb-8 leading-relaxed">
          {t('welcomeSubtitle')}
        </p>
