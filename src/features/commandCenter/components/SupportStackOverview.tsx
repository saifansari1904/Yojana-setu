    ...
    >
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs text-[#516A5F] dark:text-[var(--text-tertiary)] font-medium">5 Areas</span>
        </div>
          ...
          {SUPPORT_CATEGORIES.map(category => {
            ...
            return (
              <button
                ...
                className="w-full flex items-center justify-between py-3 px-2 rounded-lg text-left transition-colors hover:bg-[#FAFAF9] dark:hover:bg-[var(--bg-raised)] focus:outline-none focus:ring-2 focus:ring-slate-300 dark:focus:ring-emerald-800 group min-h-[44px]"
              >
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-[#F3F4F3] dark:bg-[var(--bg-raised)] flex items-center justify-center text-[#516A5F] dark:text-[var(--text-secondary)] group-hover:bg-[#14453D] group-hover:text-white transition-colors shrink-0">
                    <Icon className="w-4 h-4" />
                  </div>
                  <span className="text-sm font-medium text-[#14453D] dark:text-[var(--text-main)] group-hover:text-[#1A1C1B] dark:group-hover:text-white">
                    {category}
                  </span>
                </div>
