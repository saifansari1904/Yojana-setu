...
> = {
  EXPLORE_DETAILS: {
    ...
    reason: {
      ...
      mr: 'योजनेची मार्गदर्शक तत्त्वे आणि अधिकृत पात्रता अटी पहा.',
    },
  },
  INELIGIBLE_ALTERNATIVES: {
    ...
    reason: {
      ...
      mr: 'तुमची प्रोफाइल वैधानिक पात्रता निकष पूर्ण करत नाही.',
    },
  },
  COMPLETE_PROFILE: {
    action: {
    ...
    reason: {
      ...
      mr: 'अचूक पात्रता आणि अनुदान निश्चित करण्यासाठी उर्वरित माहिती द्या.',
    },
  },
  TRACK_PROGRESS: {
    action: {
    ...
    reason: {
      ...
      mr: 'अधिकृत पोर्टलवरील अद्यतने आणि पुढील वेळापत्रक पहा.',
    },
  },
  PROCEED_OFFICIAL_PORTAL: {
    ...
    reason: {
      ...
      mr: 'सर्व आवश्यक कागदपत्रे तयार आहेत. अधिकृत अर्जासाठी तयार.',
    },
  },
  CONTINUE_PREPARATION: {
    action: {
      ...
      mr: 'अर्जाची तयारी पुढे चालू ठेवा',
    },
    reason: {
      ...
      mr: 'या योजनेसाठी तयारी पुढे न्या.',
    },
  },
};
  ...
  if (matchResult.hasBlocker) {
    ...
    if (unpreparedDoc) {
      ...
      customActionLocalized = {
        ...
        mr: `${unpreparedDoc.name} तयार करा`,
      };
      customReasonLocalized = {
        ...
        mr: `हे तुमचा ${scheme.code} अर्ज अर्जासाठी तयार स्थितीकडे नेईल.`,
      };
    } else {
      ...
      customReasonLocalized = {
        ...
        mr: `${scheme.code} साठी तयारी पुढे न्या.`,
      };
    }
  }
