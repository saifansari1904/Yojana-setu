...
export const SCHEME_DETAIL_I18N: Record<Language, SchemeDetailI18nStrings> = {
  ...
  mr: {
    prepWorkspace: 'तयारी कार्यक्षेत्र',
    nextBestAction: 'सर्वोत्तम पुढील पाऊल',
    whyHelpBiz: 'हे आपल्या व्यवसायासाठी कसे फायदेशीर ठरू शकते',
    businessStage: 'व्यवसाय टप्पा:',
    generalSetup: 'सामान्य सेटअप',
    primaryNeed: 'प्राथमिक गरज:',
    capitalAssistance: 'भांडवल / कर्ज सहाय्य',
    fundingGap: 'निधी तफावत:',
    notSpecified: 'निर्दिष्ट केलेले नाही',
    verifiedBenefit: 'सत्यापित योजना लाभ: ',
    relevanceRationale: 'सुसंगतता विश्लेषण: ',
    supportedNeeds: 'समर्थित गरजा:',
    purposeCoreFocus: 'उद्देश व मुख्य भर',
    needed: 'आवश्यक',
    fundingFitAnalysis: 'निधी सुसंगतता विश्लेषण',
    withinRange: 'मर्यादेत',
    exceedsCap: 'कमाल मर्यादा ओलांडते',
    info: 'माहिती',
    upToSubsidy: (pct) => `${pct}% पर्यंत अनुदान`,
    months: 'महिने',
    match: 'जुळणी',
    prepare: 'तयारी',
    relevanceLevels: {
      HIGH: 'उच्च व्यावसायिक गरज सुसंगतता',
      MEDIUM: 'मध्यम व्यावसायिक सुसंगतता',
      LOW: 'कमी गरज सुसंगतता',
      UNKNOWN: 'सुसंगतता व्यापक / अनिर्दिष्ट',
    },
  },
};
