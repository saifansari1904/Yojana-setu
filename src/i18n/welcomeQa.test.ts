...
const WELCOME_KEYS = [
  'navHome', 'navHowItWorks', 'navSchemes', 'navAbout', 'navSignIn',
  'heroTitle', 'heroSubtitle', 'heroPrimaryCta', 'heroNoAccount',
  ...
  'valueDiscoveryTitle', 'valueDiscoveryDesc',
  'valueEligibilityTitle', 'valueEligibilityDesc',
  'valueFundingTitle', 'valueFundingDesc',
  'valuePrepTitle', 'valuePrepDesc',
  'valueTrackingTitle', 'valueTrackingDesc',
  'privacyTitle', 'privacySubtitle',
  'privacyPoint1', 'privacyPoint2', 'privacyPoint3', 'privacyPoint4', 'privacyPoint5',
  'footerTagline', 'footerNote',
  'authPromptTitle', 'authPromptDesc', 'authPromptPrimary', 'authPromptSecondary',
  'loginContinueTitle', 'loginWhyAccount', 'loginBenefit1', 'loginBenefit2', 'loginBenefit3',
];
