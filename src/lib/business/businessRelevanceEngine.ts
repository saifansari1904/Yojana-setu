...
const RELEVANCE_BADGE_LOCALIZED: Record<string, Record<Language, string>> = {
  HIGH: {
    ...
    mr: 'उच्च व्यावसायिक गरज प्रासंगिकता',
  },
  MEDIUM: {
    ...
    mr: 'मध्यम व्यावसायिक प्रासंगिकता',
  },
  LOW: {
  ...
  UNKNOWN: {
    ...
    mr: 'व्यापक प्रासंगिकता / अनिर्दिष्ट',
  },
};
...
const RELEVANCE_EXPLANATION_TEMPLATES: Record<string, Record<Language, (needLabel: string) => string>> = {
  HIGH: {
    ...
    mr: (need) => `हे थेट ${need} साठी तुमच्या प्राथमिक गरजेचे निराकरण करते आणि तुमच्या व्यवसायाच्या अवस्थेशी जुळते.`,
  },
  MEDIUM: {
    ...
    mr: () => 'ही योजना तुमच्या उद्योग प्रोफाइलशी जुळणारे सामान्य उद्यम कर्ज पुरवते.',
  },
  LOW: {
    ...
    mr: () => 'योजनेचे लक्ष्य तुमच्या प्राथमिक कार्यात्मक सहाय्य गरजेला किंवा अवस्थेला थेट गाठत नाही.',
  },
  UNKNOWN: {
    ...
    mr: () => 'सामान्य निधी उपलब्ध आहे; प्रासंगिकता अचूक करण्यासाठी प्राधान्य व्यवसाय गरजा निर्दिष्ट करा.',
  },
};
